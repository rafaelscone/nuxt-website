<template>
  <div class="bg-white">
    <div class="mx-auto max-w-7xl py-6 sm:px-6 sm:py-32 lg:px-2">
      <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
        <h2 class="mx-auto max-w-2xl text-4xl font-bold tracking-tight text-white">Rafael Schneide -Rafael Scone.</h2>
        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">This is a test of using Nuxt</p>
